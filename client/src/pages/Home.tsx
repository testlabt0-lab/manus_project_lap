...
const PACKAGE_URL = "/manus-storage/MediCare_Pro_Audit_Log_Source_f9166c9c.zip";
...
function LiveOperationsManager({ navigate }: { navigate: (to: string) => void }) {
  ...
  const audit = trpc.audit.listOperations.useQuery(undefined, { enabled: canManage });
